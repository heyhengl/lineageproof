...
Current deadline route: Google says Content API for Shopping sunsets on 18 August 2026. The [seven-control Merchant API migration plan](https://heyhengl.github.io/lineageproof/studio/notes/merchant-api-migration-controls/) includes a blank method inventory and a USD 249 fixed source-only review for custom integrations. It does not require live Merchant Center access or credentials.
...
| [Content API to Merchant API source-only migration review](https://heyhengl.github.io/lineageproof/studio/notes/merchant-api-migration-controls/) | USD 249 for one authorized source snapshot, up to 25 legacy call sites, three jobs, three sub-APIs and one review round | [Seven-control plan and blank method inventory](https://heyhengl.github.io/lineageproof/studio/notes/merchant-api-migration-controls/) | [Merchant API inquiry](https://github.com/heyhengl/lineageproof/issues/new?template=merchant-api-migration-intake.yml) |
