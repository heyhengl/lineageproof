...
uv run --python 3.12 --isolated --no-editable \
  --refresh-package lineageproof --extra dev --with pillow \
...
- The final Devpost URL must point to a public YouTube, Vimeo, or Youku page. GitHub Pages is a
  preview surface and does not satisfy the official host allowlist.
